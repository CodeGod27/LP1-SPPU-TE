...
public static void main(String args[])throws Exception
 {
 FileReader FP=new
FileReader("C:\\Users\\91976\\Desktop\\Practicals\\LP\\input.txt");
...
tokens[1].equalsIgnoreCase("ORIGIN")||tokens[1].equalsIgnoreCase("EQU")||tokens[1]
.equalsIgnoreCase("LTORG")) //if Assembler Directive
 {
